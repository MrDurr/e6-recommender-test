...
class VideoItem extends StatelessWidget {
  ...
  static Future<String> getIndexUrl(int idx) async {
    // Call this async function to ensure the posts are loaded in the background
    E621PostRetriever.loadPosts();
    final post = await E621PostRetriever.fetchPost();

    if (post == null) {
      throw UnimplementedError("Handling null posts is not implemented.");
    }
